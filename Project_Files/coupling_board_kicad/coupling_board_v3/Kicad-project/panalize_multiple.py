...
############### Custom config
board1_path = ".\DSUB_ADCIO_adapter\DSUB_ADCIO_adapter.kicad_pcb"
board2_path = ".\coupler_board\coupler_board.kicad_pcb"
output_path = ".\coupler_and_adapter.kicad_pcb"
...
# Place two boards next to each other
panelOrigin = VECTOR2I(0,0)
placer = BasicGridPosition(board_spacing, board_spacing) #HorSpace, VerSpace
area1 = panel.appendBoard(board1_path, panelOrigin + placer.position(0,0, None) , origin=Origin.Center, sourceArea=sourceArea1, )
area2 = panel.appendBoard(board2_path, panelOrigin + placer.position(0,-1.3, area1), origin=Origin.Center, sourceArea=sourceArea2,inheritDrc=False)
